# Generated by Django 3.1 on 2020-09-15 20:25

from django.conf import settings
from django.db import migrations, models
import django.db.models.deletion
import djmoney.models.fields
import shop_system.models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('shop_system', '0017_auto_20200915_1632'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='product',
            name='image',
            field=models.ImageField(blank=True, upload_to=shop_system.models.image_upload_to, verbose_name='Image'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('completed', 'Completed'), ('pending', 'Pending'), ('cancelled', 'Cancelled')], max_length=50, verbose_name='Order Status')),
